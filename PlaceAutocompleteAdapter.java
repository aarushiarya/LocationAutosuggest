...
class PlaceAutocompleteAdapter extends ArrayAdapter<AutocompletePrediction> implements Filterable {
    ...
    private static final String TAG = "PlaceAutocompleteFR";
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        ...
        try {
            ...
            Toast.makeText(getContext(), "Error contacting API: Please wait. " ,
                    Toast.LENGTH_SHORT).show();
            int e1 = Log.e(TAG, "Error getting autocomplete prediction API call", e);
            return null;
        }
    }
}
